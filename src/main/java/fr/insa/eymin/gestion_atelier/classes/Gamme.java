...
public class Gamme {
    ...
    private ArrayList<Equipement> equipements; // Liste des équipements nécessaires pour la gamme
    ...
    public void afficherGamme() {
        ...
        System.out.println("refGamme = " + refGamme + ", dGamme = " + dGamme + ", operations = " + listeOp
                + ", equipements = " + listeEq + "\n");
    }
